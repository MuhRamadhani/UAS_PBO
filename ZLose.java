...
/**
 * Write a description of class ZLose here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ZLose extends World
{

    /**
     * Constructor for objects of class ZLose.
     * 
     */
    public ZLose()
    {    
    ...
    public void prepare(){
        ...
        addObject(new TLose (), 400, 236);
        addObject(new BRetry(), 400, 525);
    }
}
